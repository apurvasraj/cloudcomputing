...
public class HelloAppEngine extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) 
	  ...
	  System.out.println("vision is: " + vision);
	  String numberofimage = request.getParameter("numberofimage");
	  System.out.println("numberofimage is: " + numberofimage);
...
//  
  ...
  System.out.println("pq.countEntities() --> " + pq.countEntities());
  ...
  request.setAttribute("addedDate", addedDate);
